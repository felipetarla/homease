...
const RentModal = () => {
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Ajude as pessoas a te encontrar"
        />
        <CountrySelect 
          value={location} 
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Compartilhe algumas coisas básicas sobre seu lugar"
        ...
        <Counter 
          ...
          value={guestCount}
          title="Pessoas" 
          subtitle="Quantas pessoas você acomoda?"
        />
        <hr />
        <Counter 
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Mostre as pessoas como é o seu lugar!"
        />
        <ImageUpload
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="O básico funciona melhor!"
        />
        <Input
          id="title"
          label="Título"
